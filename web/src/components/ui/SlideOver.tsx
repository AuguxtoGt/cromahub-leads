        ...
        <div className="p-4 border-t border-border bg-muted/30 flex gap-3">
          ...
          {waLink && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 px-4 py-2 bg-green-500 hover:bg-green-600 text-white font-medium rounded-md transition-colors shadow-sm flex items-center justify-center gap-2 text-sm"
            >
              <WhatsAppIcon className="w-4 h-4" />
              WhatsApp
            </a>
          )}
          {lead?.status_pipeline === 'READY' && onQueueLead && (
            <button 
              onClick={() => onQueueLead(lead)}
              className="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-md transition-colors shadow-sm flex items-center justify-center gap-2 text-sm"
            >
          ...
          {onGenerateIA && (
            <button 
              onClick={() => onGenerateIA(lead)}
              className="flex-1 px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-medium rounded-md transition-colors shadow-sm flex items-center justify-center gap-2 text-sm"
            >
              <Sparkles className="w-4 h-4" />
              {lead?.ai_message ? 'Refazer IA' : 'Gerar IA'}
            </button>
          )}
        </div>
      </div>
